...
extension EntryQueryWhereSort on QueryBuilder<Entry, Entry, QWhere> {
  QueryBuilder<Entry, Entry, QAfterWhere> anyEntryID() {
...
extension EntryQueryWhere on QueryBuilder<Entry, Entry, QWhereClause> {
  QueryBuilder<Entry, Entry, QAfterWhereClause> entryIDEqualTo(Id entryID) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Entry, Entry, QAfterWhereClause> entryIDNotEqualTo(Id entryID) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(
              IdWhereClause.lessThan(upper: entryID, includeUpper: false),
            )
            .addWhereClause(
              IdWhereClause.greaterThan(lower: entryID, includeLower: false),
            );
      } else {
        return query
            .addWhereClause(
  ...
  QueryBuilder<Entry, Entry, QAfterWhereClause> entryIDGreaterThan(Id entryID,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.greaterThan(lower: entryID, includeLower: include),
      );
    });
  }

  QueryBuilder<Entry, Entry, QAfterWhereClause> entryIDLessThan(Id entryID,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.lessThan(upper: entryID, includeUpper: include),
      );
    });
  }

  QueryBuilder<Entry, Entry, QAfterWhereClause> entryIDBetween(
    Id lowerEntryID,
    Id upperEntryID, {
...
extension EntryQueryFilter on QueryBuilder<Entry, Entry, QFilterCondition> {
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> createdDateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> createdDateGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> createdDateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> createdDateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> entryIDEqualTo(Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'entryID',
        value: value,
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> entryIDGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> entryIDLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> entryIDBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension EntryQuerySortBy on QueryBuilder<Entry, Entry, QSortBy> {
  ...
  QueryBuilder<Entry, Entry, QAfterSortBy> sortByCreatedDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdDate', Sort.asc);
    });
  }

  QueryBuilder<Entry, Entry, QAfterSortBy> sortByCreatedDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension EntryQuerySortThenBy on QueryBuilder<Entry, Entry, QSortThenBy> {
  ...
  QueryBuilder<Entry, Entry, QAfterSortBy> thenByCreatedDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdDate', Sort.asc);
    });
  }

  QueryBuilder<Entry, Entry, QAfterSortBy> thenByCreatedDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdDate', Sort.desc);
    });
  }

  QueryBuilder<Entry, Entry, QAfterSortBy> thenByEntryID() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'entryID', Sort.asc);
    });
  }

  QueryBuilder<Entry, Entry, QAfterSortBy> thenByEntryIDDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension EntryQueryWhereDistinct on QueryBuilder<Entry, Entry, QDistinct> {
  ...
  QueryBuilder<Entry, Entry, QDistinct> distinctByCreatedDate() {
    return QueryBuilder.apply(this, (query) {
...
extension EntryQueryProperty on QueryBuilder<Entry, Entry, QQueryProperty> {
  QueryBuilder<Entry, int, QQueryOperations> entryIDProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Entry, DateTime, QQueryOperations> createdDateProperty() {
    return QueryBuilder.apply(this, (query) {
